...
sealed class AuraCustomizationRoute(val route: String) {
    // Main Iconify
    data object IconifyPicker : AuraCustomizationRoute("aura/iconify")
    data object IconifyCategory : AuraCustomizationRoute("aura/iconify/{category}") {
        fun createRoute(category: String) = "aura/iconify/$category"
    }

    // Iconify Sub-categories
    data object IconPacksScreen : AuraCustomizationRoute("aura/iconify/icon_packs")
    data object BatteryStylesScreen : AuraCustomizationRoute("aura/iconify/battery_styles")
    data object BrightnessBarsScreen : AuraCustomizationRoute("aura/iconify/brightness_bars")
    data object QSPanelScreen : AuraCustomizationRoute("aura/iconify/qs_panel")
    data object NotificationsScreen : AuraCustomizationRoute("aura/iconify/notifications")
    data object VolumePanelScreen : AuraCustomizationRoute("aura/iconify/volume_panel")
    data object NavigationBarScreen : AuraCustomizationRoute("aura/iconify/navigation_bar")
    data object UIRoundnessScreen : AuraCustomizationRoute("aura/iconify/ui_roundness")
    data object IconShapeScreen : AuraCustomizationRoute("aura/iconify/icon_shape")
    data object StatusBarScreen : AuraCustomizationRoute("aura/iconify/status_bar")
    data object XposedFeaturesScreen : AuraCustomizationRoute("aura/iconify/xposed_features")
    data object ColorEngineScreen : AuraCustomizationRoute("aura/iconify/color_engine")

    // ColorBlendr
    data object ColorBlendr : AuraCustomizationRoute("aura/colorblendr")
    data object ColorBlendrMonet : AuraCustomizationRoute("aura/colorblendr/monet")
    data object ColorBlendrPalette : AuraCustomizationRoute("aura/colorblendr/palette")
    data object ColorBlendrPerApp : AuraCustomizationRoute("aura/colorblendr/per_app")

    // PixelLauncherEnhanced
    data object PixelLauncherEnhanced : AuraCustomizationRoute("aura/pixel_launcher_enhanced")
    data object PLEIcons : AuraCustomizationRoute("aura/ple/icons")
    data object PLEHomeScreen : AuraCustomizationRoute("aura/ple/home_screen")
    data object PLEAppDrawer : AuraCustomizationRoute("aura/ple/app_drawer")
    data object PLERecents : AuraCustomizationRoute("aura/ple/recents")

    // Icon Picker
    data object IconPicker : AuraCustomizationRoute("aura/iconify/icon_picker/{category}") {
