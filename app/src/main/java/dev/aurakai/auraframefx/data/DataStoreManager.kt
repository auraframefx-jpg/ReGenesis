...
class DataStoreManager @Inject constructor(
    ...
    suspend fun storeString(key: String, value: String) {
        try {
            ...
            Timber.tag("DataStore").d("Stored string: $key")
        } catch (e: Exception) {
    ...
    suspend fun storeBoolean(key: String, value: Boolean) {
        try {
            ...
            Timber.tag("DataStore").d("Stored boolean: $key = $value")
        } catch (e: Exception) {
    ...
    suspend fun storeInt(key: String, value: Int) {
        try {
            ...
            Timber.tag("DataStore").d("Stored int: $key = $value")
        } catch (e: Exception) {
    ...
    suspend fun storeLong(key: String, value: Long) {
        try {
            ...
            Timber.tag("DataStore").d("Stored long: $key = $value")
        } catch (e: Exception) {
    ...
    suspend fun storeFloat(key: String, value: Float) {
        try {
            ...
            Timber.tag("DataStore").d("Stored float: $key = $value")
        } catch (e: Exception) {
    ...
    suspend inline fun <reified T> storeObject(key: String, obj: T) {
        try {
            ...
            Timber.tag("DataStore").d("Stored object: $key")
        } catch (e: Exception) {
    ...
    suspend fun importSettings(settings: Map<String, Any>) {
        try {
            ...
            Timber.tag("DataStore").i("Successfully imported ${settings.size} settings")
        } catch (e: Exception) {
    ...
    suspend fun migrateIfNeeded() {
        ...
        if (currentVersion < targetVersion) {
            Timber.tag("DataStore").i("Migrating data from version $currentVersion to $targetVersion")
    ...
    suspend fun removeKey(key: String) {
        try {
            ...
            Timber.tag("DataStore").d("Removed key: $key")
        } catch (e: Exception) {
