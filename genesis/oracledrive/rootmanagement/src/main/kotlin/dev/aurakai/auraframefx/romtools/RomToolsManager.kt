...
/**
 * Base interface for ROM operations.
 */
sealed interface RomOperation {
    companion object {
        val GenesisOptimizations: Any
        val InstallRecovery: Any
        val UnlockBootloader: Any
        val CreateBackup: Any
        val RestoreBackup: Any
        val FlashRom: Any
    }
}
...
/**
 * Status of system optimization installation.
 */
...
/**
 * Result of ZIP file integrity verification.
 */
